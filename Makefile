...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Fri Dec 4 22:31:40 2009
# Project:  RubyCad.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.6/mkspecs/macx-g++ -macx -o Makefile RubyCad.pro
#############################################################################
...
Makefile: RubyCad.pro  /usr/local/Qt4.6/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
		/usr/local/Qt4.6/mkspecs/common/mac.conf \
		/usr/local/Qt4.6/mkspecs/common/mac-g++.conf \
		/usr/local/Qt4.6/mkspecs/qconfig.pri \
		/usr/local/Qt4.6/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/local/Qt4.6/mkspecs/macx-g++ -macx -o Makefile RubyCad.pro
...
RubyCad.app/Contents/Info.plist: 
	...
	@sed -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,RubyCad,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.6/mkspecs/macx-g++/Info.plist.app >RubyCad.app/Contents/Info.plist
dist: 
